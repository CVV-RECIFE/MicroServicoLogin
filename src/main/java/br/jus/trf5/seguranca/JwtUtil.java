...
//	}
	...
	public Boolean validarToken(String token, UserDetails userDetails) {
		...
		return (userlogin.equals(user.getLogin()) && Integer.parseInt(userSecao) == user.getCodsecao()
				&& !ehTokenExpirado(token)
				&& !foiCriadoAntesUltimaSenhaSerResetada(criadoem, user.getUltimaAtualizacaoSenha()));
	}
